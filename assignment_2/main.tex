	...
	\item 
		MCQs with More than One Correct
			\begin{enumerate}
				...
				\item
					Let $X$ and $Y$ be two arbitrary, $3 \times 3$, non-zero, skew-symmetric matrices and Z be an arbitrary $3 \times 3$, non-zero, symmetric matrix. Then which of the following matrices is \brak{are} skew symmetric?
					\begin{enumerate}
						\item $Y^3Z^4 -Z^4Y^3$
						\item $X^{44} + Y^{44}$
						\item $X^4Z^3 -Z^3X^4$
				...
				\item
					Let $a, \lambda, \mu, \in \mathbb{R}$. Consider the system of linear equations $$ax+2y=\lambda$$ $$3x-2y=\mu$$ Which of the following statement\brak{s} is \brak{are} correct?
					\begin{enumerate}
					...
					\hfill \brak{JEE Adv. 2016}
				\item 
					Which of the following is \brak{are} not the square of a $3 \times 3$ matrix with real entries?
						\begin{enumerate}
							\item 
								$\begin{bmatrix}
									1&0&0\\
